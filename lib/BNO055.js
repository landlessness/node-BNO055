...
var BNO055 = module.exports = function(options) {
  ...
  if ('calibration' in options) {
    this.initialCalibration = options.calibration;
  }
};
...
BNO055.prototype.begin = function(mode, cb) {
  ...
  if (self.initialCalibration) {
    startupRoutines.push(
      function initializeCalibration(callback) {
        self.writeVector(ACCEL_OFFSET_X_LSB_ADDR, self.initialCalibration, callback);
      }
    );
  }
...
BNO055.prototype.getCalibrationData = function(cb) {
  ...
  async.waterfall([
    ...
    function readConfigData(callback) {
